<div class="row my-2">
  <div class="col">
    <form action="<?php echo  Yii::app()->request->url ?>" class="form-inline">
      ...
      <input type=" text" placeholder="请输入你要查询的商品名称" name="keyword" class="form-control">
...
<div class="row">
  <div class="col">
    <div class="card">
      <img src="static/admin/images/goods.jpg" alt="" class="card-img">
      <div class="card-body">
        <div class="card-title">商品价格</div>
        <div class="card-subtitle">商品名称</div>
      </div>
    </div>
  </div>
  <div class="col">
